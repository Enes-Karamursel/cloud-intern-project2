...
<<<<<<< HEAD
#DomainInfo.query.filter(insert_date)
...
<<<<<<< HEAD
=======
    def __get_line_count(file_paths):
        try:
            with open(file_paths, 'r') as my_file:
                line_counter = sum(1 for _ in my_file)
                return line_counter
    ...
    async def main():
        ...
        with open(file_path, "r", encoding="utf-8") as f:
            for next_n_lines in zip_longest(*[f] * 10):
                ...
                #print(f"[{processed_line_count}] Processed domain...")
